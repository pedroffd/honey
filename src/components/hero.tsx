            ...
            <div className="max-w-screen-xl pl-8 pr-8 pt-4 pb-4 mx-auto">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 md:gap- lg:grid-rows-2 h-96">
                    <Carousel cols={2} rows={1} gap={10} loop>
                        <Carousel.Item>
                            <div className="bg-heroMain relative flex items-end justify-start w-full text-left bg-center bg-cover cursor-pointer md:col-span-2 lg:row-span-2  group dark:bg-gray-500">
                                ...
                                <h2 className="z-10 p-5">
                                    ...
                                    >
                                        Fuga ea ullam earum assumenda, beatae
                                        labore eligendi.
                                    </a>
                                </h2>
                            </div>
                        ...
                        <Carousel.Item>
                            <div className="bg-heroSecond relative flex items-end justify-start w-full text-left bg-center bg-cover cursor-pointer group dark:bg-gray-500">
                                <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b dark:via-transparent dark:from-gray-900 dark:to-gray-900"></div>
                                <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
                                    <a
                                        rel="noopener noreferrer"
                                ...
                                <h2 className="z-10 p-5">
                                    ...
                                    >
                                        ...
                                        architecto exercitationem enim
                                    </a>
                                </h2>
                            </div>
                        </Carousel.Item>
                        <Carousel.Item>
                            <div className="bg-lightPink relative flex items-end justify-start w-full text-left bg-center bg-cover cursor-pointer group dark:bg-gray-500">
